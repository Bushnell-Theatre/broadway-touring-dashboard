...
/* ── PLANNING SIGNAL MODEL — REMOVED 2026-08-06 ─────────────────────────────
 *
 * planningSignal() and SIGNAL_WEIGHTS were the deprecated percentile-based
 * scoring model (Model 1). They have been superseded by BTD.signals.profileShow()
 * in js/core/signals.js (peer-cohort scaled, equal-weight). Both symbols were
 * removed in Phase 4 of the signals-consolidation refactor per SCORING_CONTRACT.md.
 *
 * History retained in git: feat/signals-consolidation, commit cbec219.
 *
 * ────────────────────────────────────────────────────────────────────────── */
